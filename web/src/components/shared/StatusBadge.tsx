...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  pending: { label: 'Pending', className: 'bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-300' },
  approved: { label: 'Approved', className: 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300' },
  spam: { label: 'Spam', className: 'bg-red-100 text-red-700 dark:bg-red-900 dark:text-red-300' },
  trash: { label: 'Trash', className: 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300' },
};
